...
def DenseNet(input_shape=None,
    ...
    '''Instantiate the DenseNet architecture
        # Arguments
            ...
            activation: Type of activation at the top layer. Can be one of 'relu' or 'sigmoid'.
    ...
    if activation not in ['relu', 'sigmoid']:
        raise ValueError('activation must be one of "relu" or "sigmoid"')
...
def DenseNet_121_model(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
...
def DenseNet_169_model(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
...
def DenseNet_201_model(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
...
def DenseNet_264_model(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
...
def __create_dense_net(nb_classes, img_input, include_top, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=-1,
                       ...
                       subsample_initial_block=False, activation='relu', attention_module=None):
    ...
    x = Dense(nb_classes, activation=activation, kernel_initializer='he_normal', kernel_regularizer=l2(weight_decay))(x)
